...
namespace GestaoIso.Controllers
{
    ...
    public class FuncaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FuncaoId,Cargo,Experiencia,DominioIdEducacao,Treinamento,CadastroResp,CadastroData,RevisaoResp,RevisaoData,AprovacaoStatus,AprovacaoResp,AprovacaoData,Status,Comentario")] Funcao funcao)
        {
            if (ModelState.IsValid)
            {
                _context.Add(funcao);
                funcao.CadastroResp = User.Identity.Name;
                funcao.CadastroData = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FuncaoId,Cargo,Experiencia,DominioIdEducacao,Treinamento,CadastroResp,CadastroData,RevisaoResp,RevisaoData,AprovacaoStatus,AprovacaoResp,AprovacaoData,Status,Comentario")] Funcao funcao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Approve(int id, [Bind("FuncaoId,Cargo,Experiencia,DominioIdEducacao,Treinamento,CadastroResp,CadastroData,RevisaoResp,RevisaoData,AprovacaoStatus,AprovacaoResp,AprovacaoData,Status,Comentario")] Funcao funcao)
        {
            if (id != funcao.FuncaoId)
            {
                return NotFound();
